...
//     document : ["docx","doc","pdf","pptx","ppt","html","css","js"],
//     app: ["exe","dmg","pkg","deb","apk","aab"]
// }
utility.types = {
    archive : ['7z', 'apk', 'ar', 'bz2', 'cab', 'cpio', 'deb', 'dmg', 'egg', 'gz', 'iso', 'jar', 'lha', 'mar', 'pea', 'rar', 'rpm', 's7z', 'shar', 'tar', 'tbz2', 'tgz', 'tlz', 'war', 'whl', 'xpi', 'zip', 'zipx', 'xz', 'pak'],
